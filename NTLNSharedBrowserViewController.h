...
@class NSString, NTLNWebView, UIBarButtonItem, windowOverlay;

@interface NTLNSharedBrowserViewController : UIViewController <MFMailComposeViewControllerDelegate, NTLNExternalServicesClientDelegate, UIWebViewDelegate, ReadItLaterDelegate, ReadabilityOAuthHttpClientDelegate, NTLNAccelerometerSensorDelegate>
{
    NSString *url;
    NTLNWebView *webView;
