...
@class NSArray, NSData, NSDictionary, NSFileHandle, NSInputStream, NSMutableData, NSMutableDictionary, NSMutableURLRequest, NSString, NSThread, NSTimer, NSURLConnection, NSURLCredential, NSURLResponse;
...
+ (id)snipSubtringOfString:(id)arg1 betweenStartString:(id)arg2 endString:(id)arg3;
