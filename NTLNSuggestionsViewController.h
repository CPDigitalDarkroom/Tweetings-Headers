...
@interface NTLNSuggestionsViewController : UITableViewController <UITableViewDelegate, UITableViewDataSource, NTLNTwitterUserClientDelegate, UISearchDisplayDelegate, UISearchBarDelegate>
{
    int currentPage;
