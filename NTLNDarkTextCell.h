...
@interface NTLNDarkTextCell : NTLNCell
{
    NSString *text;
    UIImage *icon;
    BOOL isEven;
...
- (void)createCellWithTextRoundedBottom:(id)arg1 icon:(id)arg2 isEven:(BOOL)arg3;
- (void)createCellWithTextRoundedTop:(id)arg1 icon:(id)arg2 isEven:(BOOL)arg3;
